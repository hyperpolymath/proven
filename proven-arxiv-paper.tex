...
\lstdefinelanguage{Rust}{
    ...
    keywords=[2]{i8, i16, i32, i64, i128, isize, u8, u16, u32, u64, u128, usize, f32, f64, bool, char, str, String, Vec, Option, Result, Some, None, Ok, Err, Box, Rc, Arc, Cell, RefCell},
...
% Title and authors
\title{Proven: A Formally Verified Safety Library\\for All Major Programming Languages}
...
\begin{enumerate}
    ...
    \item \textbf{Open-source implementation} available under the MPL-2.0 license.
\end{enumerate}
...
\proven{} is open source under the MPL-2.0 license. Code, documentation, and proofs are available at:
