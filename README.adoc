...
image:https://img.shields.io/badge/license-Apache--2.0-green[License: Apache-2.0]
...
Your Application (any of 89 languages)
    ...
    Language Binding (thin FFI wrapper)
          ↓
    Zig FFI Bridge (C ABI layer)
          ↓
    Idris2 Code ← MATHEMATICAL PROOFS HERE
```

**Core Implementation:** link:src/Proven/[Idris2 with dependent types] +
**FFI Bridge:** link:ffi/zig/[Zig for C ABI compatibility] +
**Language Bindings:** Thin wrappers calling verified code
