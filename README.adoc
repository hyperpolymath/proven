...
*Code that cannot crash.* Mathematically proven safe operations for 40+ languages.
...
image:https://img.shields.io/badge/languages-40%2B-orange[40+ Languages]
...
* All 25+ modules and 40+ language bindings are complete as of v1.0.0.
...
Bindings are available for Rust, Python, JavaScript, Deno, Go, Zig, Haskell, OCaml, Elixir, Gleam, Swift, Kotlin, C, C++, Ruby, PHP, Perl, Lua, Julia, R, Tcl, Bash, Common Lisp, Erlang, Prolog, COBOL, Forth, Fortran, Odin, V, Racket, ReScript, Dart, Scala, F#, Crystal, Nim, Ada, and more. See the `bindings/` directory for language-specific documentation.
...
* ✅ All 25+ core modules with dependent type proofs
* ✅ 40+ language bindings via Zig FFI
