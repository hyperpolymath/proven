...
This isn't marketing fluff. Here's what makes bulletproof-core different from regular libraries.
...
The proofs are available in `src/Bulletproof/` and we encourage you to explore them! Understanding dependent types is a valuable skill. Here are some resources:
