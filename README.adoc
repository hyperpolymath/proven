...
image:https://img.shields.io/badge/modules-60-blue[60 Modules]
...
* All 60 modules and 89 binding targets are complete as of v1.0.0.
...
│                                                                 │
│  • 60 modules with dependent types: compiler PROVES code        │
│    is correct                                                   │
