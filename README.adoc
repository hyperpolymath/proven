...
image:https://img.shields.io/badge/version-1.1.0-blue[Version 1.1.0]
image:https://img.shields.io/badge/License-Apache_2.0-blue.svg[Apache-2.0,link="https://opensource.org/licenses/Apache-2.0"]
...
This project is licensed under **Apache-2.0**. See link:LICENSE[LICENSE].
...
```
Your Application (any of 89 languages)
          ↓
...
* All 104 modules and 89 binding targets are complete as of v1.1.0.
...
* ✅ SPDX headers standardised to Apache-2.0 across all files
...
This project is licensed under https://opensource.org/licenses/Apache-2.0[Apache-2.0]. See link:LICENSE[LICENSE].
