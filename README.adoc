...
image:https://img.shields.io/badge/believe__me-0_✓-brightgreen[believe_me = 0 (fully eliminated)]
...
This project is licensed under **MPL-2.0**. See link:LICENSE[LICENSE].
...
* ✅ SPDX headers standardised to MPL-2.0 across all files
...
* ❏ Registry publishing (crates.io, npm, JSR)
