...
image::https://img.shields.io/badge/Idris-Inside-5E5086?style=flat&logo=idris&logoColor=white[Idris Inside]
image::https://img.shields.io/badge/License-PMPL--1.0--or--later-blue.svg[License: MPL-2.0]

Type-safe ReScript bindings to the link:https://github.com/hyperpolymath/proven[proven] formally verified library.
...
These bindings are designed to integrate seamlessly with link:https://github.com/hyperpolymath/rescript-tea[rescript-tea]:
...
ProvenSafeUrl is the foundation for unbreakable routing in link:https://github.com/hyperpolymath/cadre-tea-router[cadre-tea-router]:
...
- link:https://github.com/hyperpolymath/proven[proven] - Formally verified library (Idris2)
- link:https://github.com/hyperpolymath/rescript-tea[rescript-tea] - The Elm Architecture in ReScript
- link:https://github.com/hyperpolymath/cadre-tea-router[cadre-tea-router] - Type-safe routing for TEA
