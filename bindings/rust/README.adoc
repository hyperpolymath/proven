...
NOTE: ⚠️ *ARCHITECTURE CHANGE (2026-01-25)*: This directory now contains ONLY FFI wrappers that call verified Idris2 code. All Rust reimplementations have been removed.
