...
(define ProvenC-45FFIC-45SafeTensor-encodeBool (lambda (arg-0) (cond ((equal? arg-0 0) 0) (else 1))))
(define PreludeC-45EqOrd-u--C-61C-61_Eq_Int (lambda (arg-0 arg-1) (let ((sc0 (or (and (= arg-0 arg-1) 1) 0))) (cond ((equal? sc0 0) 0)(else 1)))))
(define ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_matmul_compatible (lambda (arg-0 arg-1) (ProvenC-45FFIC-45SafeTensor-encodeBool (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-0 arg-1))))
(define ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_same_shape (lambda (arg-0 arg-1) (ProvenC-45FFIC-45SafeTensor-encodeBool (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-0 arg-1))))
...
(define ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_valid_index (lambda (arg-0 arg-1) (ProvenC-45FFIC-45SafeTensor-encodeBool (let ((sc0 (PreludeC-45EqOrd-u--C-62C-61_Ord_Int arg-0 (blodwen-toSignedInt 0 63)))) (cond ((equal? sc0 1) (PreludeC-45EqOrd-u--C-60_Ord_Int arg-0 arg-1)) (else 0))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== Testing Proven FFI Exports ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr "Testing SafeTensor FFI exports:\xa;" ext-0))) (((let ((u--result1 (ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_same_shape 5 5))) (lambda () (lambda (world-0) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "  Shape equality (5, 5): " (string-append (PreludeC-45Show-u--show_Show_Int u--result1) " (expected: 1)")) "\xa;") world-0))) (((let ((u--result2 (ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_same_shape 3 5))) (lambda () (lambda (world-1) (let ((act-5 (PreludeC-45IO-prim__putStr (string-append (string-append "  Shape equality (3, 5): " (string-append (PreludeC-45Show-u--show_Show_Int u--result2) " (expected: 0)")) "\xa;") world-1))) (((let ((u--result3 (ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_valid_index 2 5))) (lambda () (lambda (world-2) (let ((act-6 (PreludeC-45IO-prim__putStr (string-append (string-append "  Valid index (2 in length 5): " (string-append (PreludeC-45Show-u--show_Show_Int u--result3) " (expected: 1)")) "\xa;") world-2))) (((let ((u--result4 (ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_valid_index 5 5))) (lambda () (lambda (world-3) (let ((act-7 (PreludeC-45IO-prim__putStr (string-append (string-append "  Valid index (5 in length 5): " (string-append (PreludeC-45Show-u--show_Show_Int u--result4) " (expected: 0)")) "\xa;") world-3))) (((let ((u--result5 (ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_matmul_compatible 3 3))) (lambda () (lambda (world-4) (let ((act-8 (PreludeC-45IO-prim__putStr (string-append (string-append "  MatMul compatible (3x3 * 3xN): " (string-append (PreludeC-45Show-u--show_Show_Int u--result5) " (expected: 1)")) "\xa;") world-4))) (((let ((u--result6 (ProvenC-45FFIC-45SafeTensor-proven_idris_tensor_matmul_compatible 3 5))) (lambda () (lambda (world-5) (let ((act-9 (PreludeC-45IO-prim__putStr (string-append (string-append "  MatMul compatible (3x3 * 5xN): " (string-append (PreludeC-45Show-u--show_Show_Int u--result6) " (expected: 0)")) "\xa;") world-5))) (let ((act-10 (PreludeC-45IO-prim__putStr "\xa;" world-5))) (let ((act-11 (PreludeC-45IO-prim__putStr "\x2713; All FFI exports working correctly!\xa;" world-5))) (PreludeC-45IO-prim__putStr "\x2713; Functions exported with C ABI and callable from Zig/C\xa;" world-5)))))))) world-4)))))) world-3)))))) world-2)))))) world-1)))))) world-0)))))) ext-0))))))
